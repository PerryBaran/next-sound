...
describe("Upload", () => {
  ...
  describe("tests", () => {
    ...
    test("renders correctly", () => {
      ...
      expect(screen.getByText(/create album/i)).toBeInstanceOf(
        HTMLHeadingElement
      )
      ...
      expect(screen.getByText(/upload album/i)).toHaveAttribute(
        "type",
        "submit"
      )
    })
  ...
  test("snapshot", () => {
    const { asFragment } = render(<UploadAlbum />)
